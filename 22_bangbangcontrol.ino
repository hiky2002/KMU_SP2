...
#define _EMA_ALPHA 0.4    // EMA weight of new sample (range: 0 to 1)
                          ...
                          // 1로 갈수록 최근 데이터의 영향, 0으로 갈수록 이전 데이터의 영향
                          
// Servo adjustment - Set _DUTY_MAX, _NEU, _MIN with your own numbers
#define _DUTY_MAX 1880 // 1880 낮을 때
#define _DUTY_NEU 1257 // 1257 0도
#define _DUTY_MIN 781 // 781 높을 때 

#define _SERVO_ANGLE_DIFF  95  // Replace with |D - E| degree 349-254=95
#define _SERVO_SPEED       100  // servo speed

#define _BANGBANG_RANGE    20  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 512 + (-1.99 * a_value) + (2.02E-03 * a_value * a_value);
}
